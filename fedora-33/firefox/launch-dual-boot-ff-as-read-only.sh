...
if [[ ! -d "${MOUNT_POINT_PATH}" && -d "/media/windows" ]]; then
	MOUNT_POINT_PATH="/media/windows";
fi
...
# launch firefox from temp profile
#	https://developer.mozilla.org/en-US/docs/Mozilla/Command_Line_Options
firefox -new-instance -private -profile "${tmpProfileDir}" -url "https://dnsleaktest.com/" &
