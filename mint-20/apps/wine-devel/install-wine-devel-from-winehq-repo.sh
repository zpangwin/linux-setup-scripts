...
addAptCustomSource winehq 'deb https://dl.winehq.org/wine-builds/ubuntu/ focal main';
...
sudo apt-get install --install-recommends -y libfaudio0 fonts-wine libwine winehq-devel;
