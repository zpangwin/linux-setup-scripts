...
addAptCustomSource virtualbox 'deb [arch=amd64] https://download.virtualbox.org/virtualbox/debian bionic contrib';
...
has_vbox_manage=$(which VBoxManage 2>/dev/null|wc -l);
