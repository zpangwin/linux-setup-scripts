...
sudo DEBIAN_FRONTEND=noninteractive apt-get remove -q -y waterfox-locale-en waterfox-classic waterfox-classic-kpe;
...
sudo rm /etc/apt/sources.list.d/waterfox-unofficial.list 2>&1 >/dev/null;
